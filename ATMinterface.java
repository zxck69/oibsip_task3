...
class BankAccount {
    ...
    void checkId() {
        ...
        if (chk.equals(customerId)) {
            ...
            System.out.println("=================================");
            System.out.println("opps!! Wrong Login!!");
            System.out.println("=================================");
    ...
    void withdraw(int amount) {
        if (this.balance > amount) {
            ...
            clrscr();
            System.out.println("=================================");
            System.out.println("SORRY!! Sufficient Balance not available for the withdrawl!");
            System.out.println("=================================");
        }
    }
    ...
    public void transfer(double amount, BankAccount acc) {
        if (this.balance < amount) {
            clrscr();
            System.out.println("=================================");
            System.out.println("opps!! Transfer Fails due to insufficient balance!");
            System.out.println("=================================");
        } else {
            this.balance -= amount;
            acc.balance += amount;
        ...
        do {
            ...
            switch (option) {
                ...
                case 'E':
                    ...
                    BankAccount bb = new BankAccount("Hetvii", "1002");
...
public class ATMinterface {
    public static void main(String[] args) {
        BankAccount ba = new BankAccount("Venky", "2001");
        ba.checkId();
    }
